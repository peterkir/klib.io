...
public class SearchArchivesTest extends TestCase {
	...
	public void testArchiveFileSearch() throws Exception {
		...
		Set<URI> found = searchFS.find(TESTDIR, ".*file1.txt", null, new SearchOption[] { SearchOption.RECURSE, SearchOption.ARCHIVE });
		assertEquals(expected, found);
	}

	public void testArchiveContentUnixNewLineSearch() throws Exception {
		Set<URI> expected = new HashSet<URI>();
		...
		Set<URI> found = searchFS.find(TESTDIR, ".*\\.txt", ".*new\\nline.*", new SearchOption[] { SearchOption.RECURSE, SearchOption.ARCHIVE });
		assertEquals(expected, found);
	}
	
	public void testArchiveContentWindowsNewLineSearch() throws Exception {
		Set<URI> expected = new HashSet<URI>();
	...
	public void testArchiveContentSearch() throws Exception {
		...
		expected.addAll(jarfiles( new String[] {
				"zip_dirA.zip!/dirA/dirJ/fileWithWindowsNewLine.txt"
				, "zip_dirA.zip!/dirA/dirJ/fileWithUnixNewLine.txt"
		}));
