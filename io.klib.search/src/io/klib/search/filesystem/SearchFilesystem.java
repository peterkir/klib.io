...
public interface SearchFilesystem {
	 ...
	 *         and contentPattern
	 */
	Set<URI> find(File folder, String filenamePattern, String contentPattern,
	 ...
	 */
	Set<URI> find(Set<File> file, Set<String> filenamePattern,
			Set<String> contentPattern, Set<String> zipArchivePattern,
			SearchOption... options);
