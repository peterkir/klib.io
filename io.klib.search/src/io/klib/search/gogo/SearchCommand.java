...
@Component(properties = { "osgi.command.scope=util",
...
public class SearchCommand {
	...
	public String searchDir(
			@Descriptor("root folder") final File rootPath,
	...
	public String searchDir(
		...
		Set<URI> files = new HashSet<URI>();
		if (recursively) {
			files = search.find(rootPath, filenamePattern, contentPattern,
	...
	public String searchDir(
		...
		files = search.find(rootPath, filenamePattern, contentPattern,
				opts.toArray(new SearchOption[opts.size()]));
		return format(files);
	}
